package com.bj.hadoop.big_data_sxt2.common;
...
public class LogCommon {
    ...
    public static enum EventEnum{
        LAUNCH(1,"launch event","e_l"),//第一次访问
        PAGEVIEW(2,"page view event","e_pv"),//浏览事件
        CHARGEREQUEST(3,"charge request event","e_crt"),//产生订单事件
        CHARGESUCCESS(4,"charge success event","e_cs"),//订单支付成功
        CHARGEREFUND(5,"charge regund event","e_cr"),//订单退款事件
